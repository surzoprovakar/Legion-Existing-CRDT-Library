...
var privateKey = fs.readFileSync(path.resolve(Config.signalling.key));
var certificate = fs.readFileSync(path.resolve(Config.signalling.cert));
var publicKey = fs.readFileSync(path.resolve(Config.signalling.public_key));
